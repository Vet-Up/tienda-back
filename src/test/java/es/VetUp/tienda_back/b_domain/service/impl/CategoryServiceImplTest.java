...
class CategoryServiceImplTest {
        ...
        void testCreateCategory() {
            ...
            CategoryEntity categoryEntityToCreate = CategoryMapper.getInstance()
                    .fromCategorytoCategoryEntity(
                            CategoryMapper.getInstance().fromCategoryDtotoCategory(categoryDtoToCreate));
            ...
            assertAll("result",
                    ...
                    () -> assertEquals("Description of new category", createdCategoryDto.description()));
        }
    ...
    class updateCategory {
        ...
        void testUpdateCategory() {
            ...
            CategoryEntity categoryEntityToUpdate = CategoryMapper.getInstance()
                    .fromCategorytoCategoryEntity(
                            CategoryMapper.getInstance().fromCategoryDtotoCategory(categoryDtoToUpdate));
    ...
    class deleteCategory {
        ...
        void testDeleteCategory() {
            ...
            // La implementación comprueba si existen productos asociados y lanza IllegalStateException si es true
            ...
            assertEquals("The category cannot be deleted because it has associated products.", exception.getMessage());
        }
    }
