...
class ProductServiceImplTest {
        ...
        class GetProductsByCategoryIdTests {
                ...
                void testGetProductsByCategoryId() {
                        ...
                        List<ProductEntity> productEntities = List.of(product1, product2);
                        when(productRepository.getProductByCategory(categoryId, page, size))
                        ...
                        ProductEntity productEntityToCreate = ProductMapper.getInstance()
                                        .fromProducttoProductEntity(
                                                        ProductMapper.getInstance()
                                                                        .fromProductDtotoProduct(productDtoToCreate));
        ...
        class updateProductTests {
                ...
                void testUpdateProduct() {
                        ...
                        ProductEntity productEntityToUpdate = ProductMapper.getInstance()
                                        .fromProducttoProductEntity(
                                                        ProductMapper.getInstance()
                                                                        .fromProductDtotoProduct(productDtoToUpdate));
                        ...
                        when(productRepository.updateProduct(productIdToUpdate, productEntityToUpdate))
                ...
                void testUpdateProductNotFound() {
                        ...
                        assertEquals("Product with id " + productDtoToUpdate.productId() + " does not exist",
        ...
        class deleteProductTests {
                ...
                void testDeleteProductNotFound() {
                        ...
                        assertEquals("Product with id " + productIdToDelete + " does not exist",
                                        exception.getMessage());
                }
