...
VALUES
('Dog Premium Food', 'High quality food for adult dogs.', 25.99, 21.05, 'purina-dog-premium-food.png', 'Purina', 1, 150),
('Cat Tuna Pack', 'Tuna-based wet food for cats.', 15.50, 13.02, 'whiskas_humedo_pescados_gatos.jpg', 'Whiskas', 1, 200),
('Chew Toy Bone', 'Durable rubber bone for dogs.', 9.99, NULL, 'chew-toy-bone-kong.jpg', 'Kong', 2, 75),
('Cat Feather Wand', 'Interactive feather toy.', 7.99, 6.47, 'cat-feather-wand-trixie.jpg', 'Trixie', 2, 120),
...
('Puppy Starter Food', 'Balanced nutrition for growing puppies.', 18.99, 16.90, 'purina-pro-plan-dog-puppy-starter-medium-pollo.png', 'Purina', 1, 80),
('Senior Dog Chicken Mix', 'Soft and nutritious food for senior dogs.', 22.50, 20.02, 'Royal-Canin-Medium-pienso-senior.jpg', 'Royal Canin', 1, 60),
('Cat Salmon Dry Food', 'High-protein salmon-based dry food.', 19.99, 17.59, 'cat-salmon-dry-food-whiskas.jpg', 'Whiskas', 1, 90),
('Rabbit Veggie Blend', 'Healthy vegetable mix for rabbits.', 12.99, 11.56, 'vitakraft-barrita-de-verdura.jpg', 'Vitakraft', 1, 45),
('Hamster Nut Mix', 'Crunchy nut and seed mix for hamsters.', 6.50, 5.98, 'versele-comida-hamster.png', 'Versele-Laga', 1, 110),
('Squeaky Duck Toy', 'Yellow rubber duck that squeaks when pressed.', 5.99, 4.97, 'squeaky-duck-toy-kong.jpg', 'Kong', 2, 200),
('Rope Tug Toy', 'Strong rope for tug-of-war games.', 8.99, 8.00, 'rope-tug-toy-trixie.jpg', 'Trixie', 2, 85),
('Laser Pointer', 'Interactive laser toy for cats.', 4.99, NULL, 'laser-pointer-petsafe.png', 'PetSafe', 2, 150),
('Bird Swing', 'Wooden swing for small birds.', 9.50, 8.45, 'bird-swing-pennplax-4.jpg', 'Penn-Plax', 2, 65),
('Hedgehog Plush Toy', 'Soft plush toy for dogs and cats.', 11.99, 9.95, 'hedgehog-plush-toy-zippypaws.png', 'ZippyPaws', 2, 95),
...
('Pet Water Fountain', 'Automatic filtered water dispenser.', 45.99, 40.01, 'pet-water-fountain-catit.png', 'Catit', 3, 30),
('Cat Scratching Post', 'Durable scratching post with sisal rope.', 29.99, 27.89, 'cat-scratching-post-trixie.jpg', 'Trixie', 3, 55),
('Travel Water Bottle', 'Portable water bottle for outdoor walks.', 10.99, 9.45, 'travel-water-bottle-kurgo.jpg', 'Kurgo', 3, 130),
('Pet Bed Deluxe', 'Soft and cozy bed for medium-sized pets.', 34.99, 30.09, 'pet-bed-deluxe-ferplast.png', 'Ferplast', 3, 25),
('Pet Grooming Brush', 'Anti-shed brush for all fur types.', 14.99, 13.04, 'pet-grooming-brush.ong.jpg', 'Furminator', 4, 70),
('Dental Chew Sticks', 'Chew snacks that help clean teeth.', 7.99, 6.95, 'dental-chew-sticks-pedigree.jpg', 'Pedigree', 4, 180),
('Cat Litter Sand', 'Clumping sand with odor control.', 16.50, 15.01, 'cat-litter-sand-sanicat.png', 'Sanicat', 4, 100),
('Flea Spray', 'Effective spray to prevent fleas.', 12.99, 11.56, 'flea-spray-frontline.png', 'Frontline', 4, 75),
